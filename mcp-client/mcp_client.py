...
class LLMEngine:
    ...
    async def process_query(
        ...
        # reviews = {
        #     "레이지레이디케이크": [
        #         "당일에 급히 주문드렸는데 마침 재료가 남아서 친절하고 신속하게 만들어주셨어요!! 넘 앙증맞고 귀엽습니당",
        #         "바쁘신데도 친절하게 당일예약바로해주셔서 감사합니다",
        #         "넘 귀여워요❤️❤️❤️",
        #     ],
        #     '몽슈슈 강남점': ['카페가 예쁘고 너무 시끄럽지 않아서 얘기하기 좋아요\n 도지마롤이랑 커피도 맛있습니다ㅏㅏ~~', '백화점에서 선물용으로만 사보고 매장에 앉아서 먹어보기는 처음입니다. 커피도 맛있고, 후르츠롤과 말차롤 맛있었습니다.', '빵이 너무 맛있고 주인 아주머님께서 너무 친절 하세요^^ 또 오겠습니다 ㅎㅎ'],
        #     "파리크라상 강남역점": [
        #         "베이글 맛있습니다. 스프는 양송이인데 양이 적어서 그랬는데요 먹다보니 딱 맞더라구요. 가끔씩 들르는 빵 맛집이네요.",
        #         "🍓 딸기 베이커리의 시즌",
        #         "빵과 샌드위치 종류가 다양하고 내부에 먹고 갈 수 있는 테이블도 있어요",
        #     ],
        #     "던킨 원더스 강남": [
        #         '옛 이름 던킨 라이브, 이름을 굳이 원더스로 바꾼 건 라이브라는 애매한 명칭 때문일까? 원더스도 애매한 건 마찬가진데ㅋㅋㅋ 아무튼 다양한 도넛을 구경할 수 있고, "비싼 가격에" 구매할 수 있어서 그런지 요즘같은 불경기에 인기 자체는 예전만 못하다. 할인 받고 가면 먹을만하다. 핫 샌드위치류가 있었던 거 같은데 지금은 콜드 디저트가 주류인듯 하다. 달달한 거 땡길 때 추천!',
        #     ],
        #     "스타벅스 케이스퀘어강남점": [
        #         "달지않고 맛있어요.  칵테일도 있는 스타벅스입니다.",
        #         "코르타도 주문했어요!! \n넓고 얘기하기도 좋아요",
        #     ],
        #     "뚜레쥬르 카페역삼점": [
        #         "좋아요",
        ...
        #     "알렉산더 커피 워크": [
        #         "💛라떼💛",
        #         "강남에서 제일친절하고 커피맛이 제일 좋은 곳\n\n이번에도 방문했는데 역시나 하고 만족",
        #         "찾았다, 강남역 라떼맛집 ☕️ \n지도에서 리뷰좋은 카페를 찾다가 들어갔는데\n점심시간 즈음 해서 방문했습니다.\n정말 친절하시고 (어떻게 알고왔는지, 점심은 먹었는지 ,이런 짧지만  눈 마주치면서 기분 좋은 스몰토크 👏)\n커피도 맛있고, 심지어 물은 그냥 슥 갖다주셨어요 ㅎㅎㅎ \n국내해외 어딜 가든 라떼만 마시는 편이라 라떼를 시켰는데, 정말 맛있었어요. (맹탕라떼 아니었음)\n다음에 또 강남역에 가게되면 재방문할게요.",
        #     ],
        #     "트리오드": [
        #         "공간도 좋고 음료도 맛있어요! 좋은 시간 보냈습니다",
        #         "맛있고 분위기 좋아요!! 추천합니다 ~~",
        #         "너무 맛잇고 넓어서 모이기좋네요 강남에서 참 좋은 곳 인것 같아요 재방문했어요 또올게요^^*",
        #     ],
        #     "크리미숑": [
        #         "카톡으로 예약 후 이용했습니다! \n당일 케이크 되는거 너무 좋았어요~!! \n매장에 포토존도 마련되어있어, 선물 하는 사람도 기분 좋아지는 공간입니다 😊 ㅎㅎ \n케이크 너무 사랑스러워요❤️ \n다음에도 이용 할 일 있으면 또 방문하겠습니다!",
        #         "너무 귀여워요 ㅋㅋ 보냉백도 귀여워서 날씨가 춥지만 하나 사봤어요",
        #         "평소에 프랜차이즈 케이크로만 생일 축하하다가 이번에 처음으로 주문제작 해봤어요! 전날에 부탁드린 거였는데도 정해진 디자인들이 있어서 예쁜 걸로 고를 수 있었습니다👍🏻👍🏻 다음에는 미리 주문해서 원하는 디자인으로 받아보려구요~~",
        #     ],
        #     "보노": [
        #         "좋아요",
        #         "벌레가너무날라다녀여... 쉬려고잠깐왔는데너무빡침 \n벌레쫓다가시간다감\n아메리카노 6800원치고 아쉬움",
        #         "엄마랑 데이트하는 날이어서 방문했습니다.\n\n엄마가 식사 전이라고 음료만 사주시고, 디저트를 안 사 주셔서 디저트는 셀프 계산했네요.\n\n귀여운 곰돌이 디저트가 있어서 기분 좋았습니다.\n\n작고 귀여운 게 필요할 때 재방문하겠습니다.",
        #     ],
        # }
        # distances = {
        #     "레이지레이디케이크": 51.0,
        ...
        if mode[4]:
            ...
            # RAG 상위 결과(top_stores) 기준으로 좌표 필터링
            filtered_locations = {}
            try:
                top_names = [item.get("store_name") for item in rag_result.get("top_stores", [])[:3] if item.get("store_name")]
                if locations and top_names:
                    filtered_locations = {
                        name: coord for name, coord in locations.items() if name in top_names
                    }
            except Exception:
                filtered_locations = {}
            ...
            return {
                ...
                "locations": filtered_locations or locations
            }
